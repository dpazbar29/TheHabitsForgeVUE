...
<template>
    <section class="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 transition-colors">
        <div class="w-full max-w-md bg-white dark:bg-gray-900 rounded-xl shadow-lg p-8 transition-colors">
            <h2 class="text-2xl font-bold text-blue-800 dark:text-blue-300 mb-6 text-center transition-colors">Iniciar sesión</h2>
            <Form :validation-schema="toTypedSchema(loginSchema)" @submit="onSubmit">
                <div class="mb-4">
                    <label for="email" class="block mb-1 font-medium text-blue-700 dark:text-blue-300 transition-colors">Email</label>
                    <Field
                        id="email"
                        name="email"
                        type="email"
                ...
                <div class="mb-4">
                    <label for="password" class="block mb-1 font-medium text-blue-700 dark:text-blue-300 transition-colors">Contraseña</label>
                    <div class="relative">
                        <Field
                ...
                <div class="text-center mt-4">
                    <router-link to="/register" class="text-blue-600 dark:text-blue-400 hover:underline text-sm transition-colors">
